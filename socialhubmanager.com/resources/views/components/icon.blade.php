...
@elseif ($name == 'info')
    <svg class="flex-shrink-0 w-4 h-4 text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
...
@elseif ($name == 'connect')
    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
        class="bi bi-link-45deg mr-2" viewBox="0 0 16 16">
        <path
...
@elseif ($name == 'history')
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-list-check mr-2"
        viewBox="0 0 16 16">
...
@elseif ($name == 'calendar')
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        class="bi bi-calendar4-week mr-2" viewBox="0 0 16 16">
        <path
